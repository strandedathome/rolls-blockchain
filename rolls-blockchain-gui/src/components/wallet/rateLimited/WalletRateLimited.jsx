...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const rollsper_input = ip_parsed.limit;
    ...
    const rollsper_value = Number.parseInt(Number(rollsper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (rolls per interval):{' '}
                  {pecan_to_rolls_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
