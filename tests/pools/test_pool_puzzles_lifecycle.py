...
from rolls.wallet.puzzles.p2_conditions import puzzle_for_conditions
from rolls.wallet.puzzles import singleton_top_layer
from rolls.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - rolls.pools.pool_puzzles.py
    - rolls.wallet.puzzles.pool_member_innerpuz.clvm
    - rolls.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
