...
from rolls.pools.pool_config import PoolWalletConfig
from rolls.util.config import load_config, save_config, create_default_rolls_config
...
def test_pool_config():
    ...
    create_default_rolls_config(test_root, ["config.yaml"])
