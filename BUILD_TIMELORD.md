...
required to run a [Timelord](https://github.com/strandedathome/rolls-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/strandedathome/rolls-blockchain/blob/main/install-timelord.sh)
