...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.rolls/[version]/config/ssl/ca
    ...
    from rolls.cmds.passphrase_funcs import initialize_passphrase
...
if __name__ == "__main__":
    from .init_funcs import rolls_init
    from rolls.util.default_root import DEFAULT_ROOT_PATH

    rolls_init(DEFAULT_ROOT_PATH)
