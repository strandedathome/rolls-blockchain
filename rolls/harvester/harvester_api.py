...
from rolls.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from rolls.harvester.harvester import Harvester
from rolls.plotting.util import PlotInfo, parse_plot_info
from rolls.protocols import harvester_protocol
from rolls.protocols.farmer_protocol import FarmingInfo
from rolls.protocols.harvester_protocol import Plot
from rolls.protocols.protocol_message_types import ProtocolMessageTypes
from rolls.server.outbound_message import make_msg
...
from rolls.util.ints import uint8, uint32, uint64
from rolls.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSPecanRollsConnection
    ):
        """
