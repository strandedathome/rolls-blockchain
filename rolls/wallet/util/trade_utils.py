...
from rolls.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "rolls" in cc_discrepancies:
                    cc_discrepancies["rolls"] = cc_discrepancies["rolls"] + diff
                else:
                    cc_discrepancies["rolls"] = diff
