...
from rolls.daemon.keychain_proxy import (
    KeychainProxy,
...
from rolls.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH
from rolls.protocols import wallet_protocol
from rolls.protocols.full_node_protocol import RequestProofOfWeight, RespondProofOfWeight
...
from rolls.util.errors import Err, ValidationError
from rolls.util.ints import uint32, uint128
from rolls.util.keychain import Keychain
from rolls.util.lru_cache import LRUCache
from rolls.util.merkle_set import MerkleSet, confirm_included_already_hashed, confirm_not_included_already_hashed
...
from rolls.wallet.settings.settings_objects import BackupInitialized
...
from rolls.wallet.wallet_blockchain import ReceiveBlockResult
...
class WalletNode:
    ...
    async def get_key_for_fingerprint(self, fingerprint: Optional[int]) -> Optional[PrivateKey]:
        ...
        try:
            ...
            self.log.warning("No keys present. Create keys with the UI, or with the 'rolls keys' program.")
            return None
