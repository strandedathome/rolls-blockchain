...
from rolls.cmds.init_funcs import rolls_full_version_str
from rolls.protocols.protocol_message_types import ProtocolMessageTypes
from rolls.protocols.protocol_state_machine import message_response_ok
from rolls.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from rolls.protocols.shared_protocol import Capability, Handshake
...
from rolls.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from rolls.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSPecanRollsConnection:
    """
