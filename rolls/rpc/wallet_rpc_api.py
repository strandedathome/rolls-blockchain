...
from rolls.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from rolls.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from rolls.util.path import path_from_root
from rolls.util.ws_message import WsRpcMessage, create_payload_dict
...
from rolls.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from rolls.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from rolls.wallet.util.trade_utils import trade_record_to_dict
from rolls.wallet.util.transaction_type import TransactionType
from rolls.wallet.util.wallet_types import WalletType
from rolls.wallet.wallet_info import WalletInfo
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "rolls_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "rolls_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from rolls.pools.pool_wallet_info import initial_pool_state_from_dict
